...
function StudentLoginPage() {
  ...
  function submitHandler(e) {
    ...
    e.preventDefault();
    fetch("https://student-feedback-production-60e2.up.railway.app/api/student/login", {
      method: "POST",
      headers: {
    ...
    <div className="relative w-full h-screen">
      ...
      <div className="absolute flex flex-col justify-center items-center w-full h-full px-4">
        ...
        >
          ...
          <label className="text-[18px] md:text-[20px] w-full mb-4">
            Department :
            <select
              className="w-full border rounded-lg border-yellow-400 text-center mt-2 py-1"
              name="department"
